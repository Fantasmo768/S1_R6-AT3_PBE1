 ...
 * @description Realiza a busca de um cliente no banco de dados através do endereço de e-mail informado.
 * A função consulta a tabela `clientes` e retorna todos os registros que correspondem ao e-mail recebido.
 * 
 * @param {string} email Endereço de e-mail utilizado para localizar o cliente.
 * 
 * @returns {Promise<Array<Object>>} Retorna um array contendo os registros encontrados.
 * Caso nenhum cliente seja encontrado, retorna um array vazio.
 * 
 * @example
 * const cliente = await clienteModel.buscarPorEmail("joao@gmail.com");
 * console.log(cliente);
 * // Resultado esperado:
 * // [
 * //   {
 ...
 * const cliente = await clienteModel.buscarPorEmail("naoexiste@gmail.com");
 * console.log(cliente);
 * // []
 */
